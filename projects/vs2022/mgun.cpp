...
//
//	//	if ( pev->noise ) // fire sound
//	//		PRECACHE_SOUND( (char *)STRING(pev->noise) );
//
//	//	m_usEvent = PRECACHE_EVENT( 1, "events/statmg.sc" );
//	m_iShouldUpdate = 1;
//}
//
//
...
//
//		FireBullets(1, vecSrc, vecForward, Vector(0, 0, 0), 4096, BULLET_MONSTER_12MM, 1, m_flDamage, pActivator->pev);
