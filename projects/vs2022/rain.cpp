...
//
////ЗАКОНЧИЛ НА ЭТОМ:
////Естественно, все эти функции должны откуда-то вызываться. О ProcessRain и ProcessFXObjects 
////мы позаботимся позже, а вызовы ResetRain и InitRain вставим в нужное место прямо сейчас.
////Откройте файл hud.cpp, и в начале, рядом с остальными заголовочными модулями, добавьте подключение rain.h: