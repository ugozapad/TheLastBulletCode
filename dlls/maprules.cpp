...
{
	DEFINE_ARRAY(CGamePlayerEquip, m_weaponCount, FIELD_INTEGER, sizeof(string_t)),
	DEFINE_ARRAY(CGamePlayerEquip, m_weaponNames, FIELD_STRING, sizeof(int)),
	/*DEFINE_FIELD(CGamePlayerEquip, CGamePlayerEquip::EquipPlayer, FIELD_FUNCTION)*/
};
