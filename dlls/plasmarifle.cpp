...
void CPlasmarifle::Spawn()
{
	...
	m_iDefaultAmmo = RANDOM_LONG(10, 32);
...
void CPlasmarifle::PrimaryAttack()
{
	...
	pPlasma->pev->angles = m_pPlayer->pev->v_angle;
	pPlasma->pev->angles.x = 0;
	pPlasma->pev->rendermode = kRenderTransAdd;
	pPlasma->pev->renderamt = 255;
	pPlasma->pev->scale = 0.2;
