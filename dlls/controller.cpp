...
int CLichBoss::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
	// HACK HACK -- until we fix this.
...
//FinBossStart
class CFinBoss : public CController
{
public:
...
LINK_ENTITY_TO_CLASS(monster_final_boss, CFinBoss);
...
void CFinBoss::Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/newNpc/finalboss.mdl");
	UTIL_SetSize(pev, Vector(-32, -32, 0), Vector(32, 32, 64));
...
// Precache - precaches all resources this monster needs
//=========================================================
void CFinBoss::Precache()
{
	PRECACHE_MODEL("models/newNpc/finalboss.mdl");
...
void CFinBoss::Killed(entvars_t* pevAttacker, int iGib)
{
