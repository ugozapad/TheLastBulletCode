...
//		pCurrent->m_flPumpTime			= pfrom->m_flPumpTime;
	...
	player.ammo_338			= (int)from->client.vuser2[1];
	player.ammo_mp5			= (int)from->client.vuser2[2];
	...
	to->client.vuser2[1]				= player.ammo_338;
	to->client.ammo_rockets				= player.ammo_rockets;
	to->client.vuser2[2]				= player.ammo_mp5;
